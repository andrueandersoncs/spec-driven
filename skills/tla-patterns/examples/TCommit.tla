------------------------------- MODULE TCommit ------------------------------
(***************************************************************************)
(* Transaction Commit - The foundation of distributed transaction safety   *)
(*                                                                         *)
(* This spec models the core safety property that all resource managers    *)
(* must agree: either ALL commit or ALL abort. No mixed decisions allowed. *)
(*                                                                         *)
(* Key insight: This is the WHAT (safety requirement), while TwoPhase.tla  *)
(* is the HOW (protocol that achieves it).                                 *)
(***************************************************************************)
...
TCConsistent ==
  ...
  (* conflicting decisions. THIS IS THE KEY SAFETY PROPERTY.               *)
  (*************************************************************************)
